...
export default function Update() {
    ...
    const updateAPIData = () => {
        axios.put(`https://643d248c6afd66da6aedfe86.mockapi.io/useradmin/${id}`, {
            firstName,
             lastName,
             checkbox
        })
 ...
 <hr className='mb-6'/>
 <h1 class='text-2xl font-semibold mb-10 text-center'>Update the Resource</h1>
        ...
        <div className='mt-10 flex justify-center'>
            <Form className="create-form">
                ...
                <Form.Field>
                <span><Checkbox onChange={(e) => setCheckbox(!checkbox)}/></span> <span>I agree to the Terms and Conditions</span>                </Form.Field>
