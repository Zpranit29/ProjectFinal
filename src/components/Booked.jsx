...
useEffect(() => {
    axios.get(`https://643d248c6afd66da6aedfe86.mockapi.io/companypractice`)
        .then((response) => {
...
const onDelete = (id) => {
    axios.delete(`https://643d248c6afd66da6aedfe86.mockapi.io/companypractice/${id}`)
 .then(() => {
    getData();
})
}
...
<hr className='mb-6'/>
  <h1  className='text-center text-2xl font-semibold mb-10' > Booked Resources</h1>
    ...
    <div>
            <Table.Header >
                <Table.Row >
                    ...
                    <Table.HeaderCell>Release Resource</Table.HeaderCell>
                ...
                {APIData.map((data) => {
                    return (
                        <Table.Row>
                            ...
                            {/* <Link to='/update'> */}
                                <Table.Cell> 
                                <button class='bg-light-coreco text-white font-semibold rounded px-2' onClick={() =>{setData(data) ; onDelete(data.id)}}>Release Resource</button>
                                </Table.Cell>
                            {/* </Link> */}
